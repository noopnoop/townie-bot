...
import { Directory, GameDB, NormalInteraction } from '../types';
...
export async function executeDeleteGame (interaction : CommandInteraction & NormalInteraction, directories : Keyv<Directory>, db : GameDB) {
